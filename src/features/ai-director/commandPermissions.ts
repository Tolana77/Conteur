...
export const aiCommandSchemas: AiCommandSchema[] = [
  ...
  { type: "createItem", schema: "{ type, templateId?, template?, instance, mode?: create|replace, reason? }", description: "Crée une instance d'objet; peut aussi fournir son template si nécessaire." },
  ...
  { type: "grantAbility", schema: "{ type, characterId, templateId, reason? }", description: "Accorde une capacité existante à un personnage." },
  ...
  { type: "createEnemyTemplate", schema: "{ type, template, mode?: create|replace, reason? }", description: "Crée un template d'ennemi réutilisable." },
  ...
  { type: "createItemTemplate", schema: "{ type, template, mode?: create|replace, reason? }", description: "Crée un template d'objet d'inventaire." },
  { type: "createEffectTemplate", schema: "{ type, template, mode?: create|replace, reason? }", description: "Crée un template d'effet réutilisable." },
  { type: "createAbilityTemplate", schema: "{ type, template, mode?: create|replace, reason? }", description: "Crée un template de capacité." },
