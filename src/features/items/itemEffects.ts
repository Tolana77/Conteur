...
export const itemEffects = {
  ...
  caltropsZone: {
    ...
    variables: {
      ...
      description: "Des pointes métalliques couvrent le sol.",
      rule: "Entrer dans la zone inflige 1 dégât perforant et ralentit.",
      color: "#7A1F2E",
    },
  },
  smokeZone: {
    ...
    variables: {
      ...
      trigger: "startTurn",
      name: "Nuage de fumée",
      description: "Une fumée opaque masque les silhouettes.",
      rule: "La zone gêne fortement la vision.",
      color: "#5C5566",
    },
  },
